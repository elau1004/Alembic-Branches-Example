...
---
%%{init: { 'logLevel': 'debug', 'theme': 'base', 'gitGraph': {'showBranches': true, 'showCommitLabel':true,'mainBranchName': 'INITCORE - Long live branch'}} }%%
gitGraph
    checkout   "INITCORE - Long live branch"
    commit id: "Core new table"
    commit id: "Core func & proc"
    commit id: "Core pop data"
    commit id: "Core ver 0" type: HIGHLIGHT
    branch     "INITALL - Install all branches"
    branch     "CORE - Core Revision branch"
    branch     "INITMOD1 - Module 1 long live branch"
    checkout   "CORE - Core Revision branch"
    commit id: "Core rev1"
    commit id: "Core rev2"
    commit id: "Core rev3"
    checkout   "INITMOD1 - Module 1 long live branch"
    commit id: "Mod1 new table"
    commit id: "Mod1 func & proc"
    commit id: "Mod1 pop data"
    commit id: "Mod1 ver 0" type: REVERSE
    branch     "MOD1 - Module 1 Revision branch"
    commit id: "Mod1 rev1"
    commit id: "Mod1 rev2"
    commit id: "Mod1 rev3"
    checkout   "INITCORE - Long live branch"
    branch     "INITMOD2 - Module 2 Long live branch"
    checkout   "INITMOD2 - Module 2 Long live branch"
    commit id: "Mod2 new table"
    commit id: "Mod2 func & proc"
    commit id: "Mod2 pop data"
    commit id: "Mod2 ver 0" type: REVERSE
    branch     "MOD2 - Module 2 Revision branch"
    commit id: "Mod2 rev1"
    commit id: "Mod2 rev2"
    commit id: "Mod2 rev3"
    checkout   "INITCORE - Long live branch"
    branch     "INITMOD3 - Module 3 Long live branch"
    checkout   "INITMOD3 - Module 3 Long live branch"
    commit id: "Mod3 new table"
    commit id: "Mod3 func & proc"
    commit id: "Mod3 pop data"
    commit id: "Mod3 ver 0" type: REVERSE
    branch     "MOD3 - Module 3 Revision branch"
    commit id: "Mod3 rev1"
    commit id: "Mod3 rev2"
    commit id: "Mod3 rev3"
    checkout "INITALL - Install all branches"
